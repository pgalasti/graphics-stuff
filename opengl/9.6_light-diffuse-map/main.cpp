...
using SphereModelLoader = WavefrontVertexLoader<Vertex3DNRGBf>;
...
int main([[maybe_unused]]int argc, [[maybe_unused]]char* argv[]) {
  ...
  SphereModelLoader sphereLoader(SphereModelLoader::Format::XYZNRGB);
  ...
  const SphereModelLoader::ModelData sphereData = sphereLoader.Load("./models/sphere.obj", SphereModelLoader::LOAD_INDICES | SphereModelLoader::LOAD_NORMALS);
  ...
  while(!glfwWindowShouldClose(pWindow)) {
    ...
    // Sphere 1 
    glm::mat4 lightModelMtx1 {glm::mat4(1.0f)};
    lightModelMtx1 = glm::translate(lightModelMtx1, glm::vec3(0.0f, 1.0f, 0.0f));
    lightModelMtx1 = glm::rotate(lightModelMtx1, static_cast<float>(glfwGetTime()), glm::vec3(0.0f, 1.0f, 0.0f));
    lightModelMtx1 = glm::translate(lightModelMtx1, glm::vec3(1.0f, 0.0f, 0.0f));
    lightModelMtx1 = glm::scale(lightModelMtx1, glm::vec3(0.2f, 0.2f, 0.2f));
    
    // Sphere 2 
    glm::mat4 lightModelMtx2 {glm::mat4(1.0f)};
    lightModelMtx2 = glm::translate(lightModelMtx2, glm::vec3(0.0f, 0.0f, 0.0f));
    lightModelMtx2 = glm::rotate(lightModelMtx2, static_cast<float>(glfwGetTime()*4), glm::vec3(0.0f, 1.0f, 0.0f));
    lightModelMtx2 = glm::translate(lightModelMtx2, glm::vec3(-1.0f, 0.0f, 0.0f));
    lightModelMtx2 = glm::scale(lightModelMtx2, glm::vec3(0.2f, 0.2f, 0.2f));
    
    // Position of light should be at the 4th column of matrix
    const glm::vec3 light1Position {lightModelMtx1[3]};
    const glm::vec3 light2Position {lightModelMtx2[3]};
    ...
    // Draw Spheres 
    lightProgram.SetConstant("model", lightModelMtx1);
    ...
    lightProgram.SetConstant("model", lightModelMtx2);
    lightProgram.SetConstant("view", lookAt);
    lightProgram.SetConstant("lightColor", glm::vec3(1.0f, 1.0f, 1.0f));
    lightProgram.SetConstant("intensity", 1.0f);
    glDrawElements(GL_TRIANGLES, sphereIndices.size(), GL_UNSIGNED_INT, 0);
