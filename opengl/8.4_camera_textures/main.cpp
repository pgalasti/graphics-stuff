...
using ModelLoader = WavefrontVertexLoader<Vertex3DUVf>;
...
int main([[maybe_unused]]int argc, [[maybe_unused]]char* argv[]) {
  ...
  ModelLoader modelLoader(ModelLoader::Format::XYZUV);
  
  profiler.Start("Loading Model");
  const ModelLoader::ModelData modelData = modelLoader.Load("./models/cube_unit_uv.obj", ModelLoader::LOAD_INDICES | ModelLoader::LOAD_UV);
  ...
  glVertexAttribPointer(1, 2, GL_FLOAT, GL_FALSE, sizeof(Vertex3DUVf), (void*)(sizeof(float)*3));
